...
const carMakes: CarMake[] = [
  ...
  { id: "renault", name: "Renault", nameAr: "رينو" },
...
const carModels: CarModel[] = [
  ...
  { id: "accent", makeId: "hyundai", name: "Accent", nameAr: "أكسنت" },
  { id: "santafe", makeId: "hyundai", name: "Santa Fe", nameAr: "سانتا في" },
  { id: "creta", makeId: "hyundai", name: "Creta", nameAr: "كريتا" },
  { id: "azera", makeId: "hyundai", name: "Azera", nameAr: "أزيرا" },
  { id: "i10", makeId: "hyundai", name: "i10", nameAr: "آي 10" },
  { id: "i20", makeId: "hyundai", name: "i20", nameAr: "آي 20" },
  { id: "i30", makeId: "hyundai", name: "i30", nameAr: "آي 30" },
  { id: "palisade", makeId: "hyundai", name: "Palisade", nameAr: "باليسيد" },
  { id: "kona", makeId: "hyundai", name: "Kona", nameAr: "كونا" },
  { id: "duster", makeId: "renault", name: "Duster", nameAr: "داستر" },
  { id: "logan", makeId: "renault", name: "Logan", nameAr: "لوجان" },
  { id: "symbol", makeId: "renault", name: "Symbol", nameAr: "سيمبول" },
  { id: "megane", makeId: "renault", name: "Megane", nameAr: "ميجان" },
  { id: "fluence", makeId: "renault", name: "Fluence", nameAr: "فلوانس" },
  { id: "captur", makeId: "renault", name: "Captur", nameAr: "كابتور" },
  { id: "koleos", makeId: "renault", name: "Koleos", nameAr: "كوليوس" },
  { id: "sandero", makeId: "renault", name: "Sandero", nameAr: "سانديرو" },
  { id: "clio", makeId: "renault", name: "Clio", nameAr: "كليو" },
  { id: "talisman", makeId: "renault", name: "Talisman", nameAr: "تاليسمان" },
